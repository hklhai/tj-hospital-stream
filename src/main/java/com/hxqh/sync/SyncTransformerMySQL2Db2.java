...
public class SyncTransformerMySQL2Db2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String selectQuery = "select * from yc_transformer_current";
        ...
        String insertQuery = "INSERT INTO YC_TRANSFORMER_CURRENT (YCTRANSFORMERID,IEDNAME,COLTIME," +
                "APhaseTemperature,BPhaseTemperature,CPhaseTemperature,DRoadTemperature,CREATETIME) VALUES(?,?,?,?,?,?,?,?)";
