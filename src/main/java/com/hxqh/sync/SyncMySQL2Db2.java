...
public class SyncMySQL2Db2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String insertQuery = "INSERT INTO YC_MEDIUM_VOLTAGE_CURRENT  (IEDNAME,COLTIME," + YCMEDIUMVOLTAGE_INSERT + "CREATETIME) VALUES(?,"
        ...
        environment.execute("SyncMySQL2Db2");
