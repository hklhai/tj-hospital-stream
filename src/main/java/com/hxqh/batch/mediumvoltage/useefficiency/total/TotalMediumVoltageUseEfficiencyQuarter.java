...
public class TotalMediumVoltageUseEfficiencyQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String quarterQuery = "select ASSETYPE,PRODUCTMODEL,LOCATION,sum(RUNNINGTIME) AS TOTALRUNNINGTIME,sum(UTILIZATIONRATIO)/count(*) AS AVGUTILIZATIONRATIO " +
                "from RE_VOLTAGE_UE_QUARTER where ASSETYPE='中压开关设备' and CREATETIME = '" + RemindDateUtils.getLastQuarter() + "' " +
                "group by ASSETYPE,PRODUCTMODEL,LOCATION";
        ...
        String insertQuery = "INSERT INTO RE_ALL_VOLTAGE_UE_QUARTER(ASSETYPE,PRODUCTMODEL,LOCATION,TOTALRUNNINGTIME,AVGUTILIZATIONRATIO,CREATETIME) VALUES(?,?,?,?,?,?)";
        ...
        env.execute("TotalMediumVoltageUseEfficiencyQuarter");
