...
public class TotalMediumVoltageUseEfficiencyStatisticsQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList assetDsList = (ArrayList)assetDs.collect();

        //从mysql中取得设备的最大运行时间及对应月份
        ...
        DataSet<Tuple3<String,String, String>> join = assetjoin.groupBy(0).reduce(new ReduceFunction<Tuple3<String,String, String>>() {
            ...
            public Tuple3<String,String, String> reduce(Tuple3<String,String, String> v1, Tuple3<String,String, String> v2) throws Exception {
                ...
                Double runtimemin1 = Double.parseDouble(spitvmin1[1].toString());
                Double runtimemin2 = Double.parseDouble(spitvmin2[1].toString());
                Double runtimemax1 = Double.parseDouble(spitvmax1[1].toString());
                Double runtimemax2 = Double.parseDouble(spitvmax2[1].toString());
                System.out.println(runtimemin1+"--"+runtimemin2+"--"+runtimemax1+"--"+runtimemax2);

                if(runtimemin1>runtimemin2){
                    v1.f1 = v2.f1;
                }
                if(runtimemax2>runtimemax1){
                    v1.f2 = v2.f2;
                }
                return v1;
        ...
        String insertQuery = "INSERT INTO  RE_ALL_VOLTAGE_UE_INFO_QUARTER(ASSETYPE,PRODUCTMODEL,LOCATION,MINMONTH,MAXMONTH,PHASECURRENTMAX,PHASECURRENTMIN,PHASECURRENTAVG,CREATETIME) VALUES(?,?,?,?,?,?,?,?,?)";
        JDBCOutputFormat.JDBCOutputFormatBuilder outputBuilder =
                JDBCOutputFormat.buildJDBCOutputFormat().setDrivername(DB2_DRIVER_NAME).setDBUrl(DB2_DB_URL)
                        .setQuery(insertQuery).setSqlTypes(type).setUsername(DB2_USERNAME).setPassword(DB2_PASSWORD);
        result.output(outputBuilder.finish());

        env.execute("TotalMediumVoltageUseEfficiencyStatisticsQuarter");
