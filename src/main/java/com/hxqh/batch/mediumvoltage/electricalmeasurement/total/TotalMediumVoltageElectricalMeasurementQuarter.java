...
/**
 * 总体中压设备-季度有功电度量和无功电度量
 * <p>
 * Created by Ocean lin on 2020/3/29.
 *
 * @author Ocean lin
 */
@SuppressWarnings("Duplicates")
public class TotalMediumVoltageElectricalMeasurementQuarter {
    public static void main(String[] args) throws Exception {
        ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();

        String quarterQuery = "select assetYpe,productModel,location,productModelC,avg(ActiveElectricDegree) as ActiveElectricDegree,avg(ReactiveElectricDegree) as ReactiveElectricDegree,avg(ELECTRICDEGREE) as ELECTRICDEGREE from RE_VOLTAGE_EM_QUARTER" +
                " where CreateTime = '" + RemindDateUtils.getLastQuarter() + "' group by assetYpe,productModel,location,productModelC";
        ...
        String insertQuery = "INSERT INTO RE_ALL_VOLTAGE_EM_QUARTER(assetYpe,productModel,location,productModelC,ActiveElectricDegree,ReactiveElectricDegree,ELECTRICDEGREE,CREATETIME,REACTIVEPERCENT,OPINION) VALUES(?,?,?,?,?,?,?,?,?,?)";
        ...
        env.execute("TotalMediumVoltageElectricalMeasurementQuarter");
