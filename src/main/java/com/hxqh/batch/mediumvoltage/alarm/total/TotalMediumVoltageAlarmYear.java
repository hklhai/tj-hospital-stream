package com.hxqh.batch.mediumvoltage.alarm.total;
 ...
 * 整体中压设备-季度报警统计信息
 * <p>
 * Created by Ocean on 2020/4/12.
 *
 * @author Ocean
 */
@SuppressWarnings("DuplicatedCode")
public class TotalMediumVoltageAlarmYear {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sqlFirst = "select assetYpe,productModel,location,alarmLevel,count(*) as levelCount from yx1 " +
                "where assetYpe = '中压开关设备' and Val='1' and alarmLevel is not null " +
...
//
        ...
        String insertQuery = "INSERT INTO  RE_ALL_VOLTAGE_ALARM_YEAR(ASSETYPE,PRODUCTMODEL,LOCATION,ALARMLEVEL1COUNT,ALARMLEVEL1RATIO,ALARMLEVEL2COUNT,ALARMLEVEL2RATIO,ALARMLEVEL3COUNT,ALARMLEVEL3RATIO,VARIABLENAMEMAX,CREATETIME) VALUES(?,?,?,?,?,?,?,?,?,?,?)";
        JDBCOutputFormat.JDBCOutputFormatBuilder outputBuilder =
                JDBCOutputFormat.buildJDBCOutputFormat().setDrivername(DB2_DRIVER_NAME).setDBUrl(DB2_DB_URL)
                        .setQuery(insertQuery).setSqlTypes(type).setUsername(DB2_USERNAME).setPassword(DB2_PASSWORD);
        result.output(outputBuilder.finish());

        env.execute("TotalMediumVoltageAlarmYear");
