...
public class MediumVoltageLoadFactorCompareQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String quarterQuery = "select IEDNAME,LOADFACTOR,CREATETIME from RE_LOAD_QUARTER where CREATETIME in " + RemindDateUtils.getLastTwoQuarterString();
        ...
        String insertQuery = "INSERT INTO RE_LOAD_COMPARE_QUARTER(IEDNAME,LOADFACTOR,CREATETIME,COMPARISON,RATIO) VALUES(?,?,?,?,?)";
