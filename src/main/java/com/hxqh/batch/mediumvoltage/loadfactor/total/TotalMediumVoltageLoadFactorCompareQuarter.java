...
public class TotalMediumVoltageLoadFactorCompareQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String quarterQuery = "select ASSETYPE,PRODUCTMODEL,LOCATION,LOADFACTOR,CREATETIME from RE_TOTAL_LOAD_QUARTER where CREATETIME in " + RemindDateUtils.getLastTwoQuarterString();
