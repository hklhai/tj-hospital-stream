...
public class TotalMediumVoltageLoadFactorQuarter {
    public static void main(String[] args) throws Exception {
        ...
        String insertQuery = "INSERT INTO RE_TOTAL_LOAD_QUARTER(ASSETYPE,PRODUCTMODEL,LOCATION,LOADFACTOR,CREATETIME) VALUES(?,?,?,?,?)";
