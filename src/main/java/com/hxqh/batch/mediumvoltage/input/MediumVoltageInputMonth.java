...
public class MediumVoltageInputMonth extends RichInputFormat<Row, InputSplit> implements ResultTypeQueryable<Row> {
    ...
    public MediumVoltageInputMonth(List<HttpHost> httpHosts,
    ...
    public static class Builder {
        ...
        public MediumVoltageInputMonth build() {
            Preconditions.checkNotNull(this.rowTypeInfo);
            MediumVoltageInputMonth input = new MediumVoltageInputMonth(httpHosts, restClientFactory, index);
