...
public class LowPressureUseEfficiencyQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Row> result = lowData.join(lowMonthData).where(0).equalTo(0).with(new JoinFunction<Tuple3<String, String,String>, Tuple3<String, String,Double>, Row>() {
            ...
            public Row join(Tuple3<String, String,String> first, Tuple3<String, String,Double> second) throws Exception {
                ...
                row.setField(7, second.f2 / 60 / (24 * 90));//转换为比率
                row.setField(8, RemindDateUtils.getLastQuarter());
                return row;
            }
        });

        String insertQuery = "INSERT INTO RE_LP_UE_QUARTER(IEDNAME,ASSETYPE,LOCATION,PRODUCTMODEL,PRODUCTMODELB,PRODUCTMODELC,RUNNINGTIME,UTILIZATIONRATIO,CREATETIME) " +
                "VALUES(?,?,?,?,?,?,?,?,?)";
        ...
        env.execute("LowPressureUseEfficiencyQuarter");
    }
