...
public class LowPressureUseEfficiencyCompareQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String quarterQuery = "select IEDNAME,ASSETYPE,LOCATION,PRODUCTMODEL,PRODUCTMODELB,PRODUCTMODELC,UTILIZATIONRATIO,RUNNINGTIME,CREATETIME" +
                " from RE_LP_UE_QUARTER where ASSETYPE like '低压开关设备%' and CREATETIME in "+RemindDateUtils.getLastTwoQuarterString();
        ...
        DataSet<Tuple6<String, String,Double,String,String,Double>> quarterData = quarterRow.map(new MapFunction<Row, Tuple6<String, String,Double,String,String,Double>>() {
            @Override
        ...
        DataSet<Tuple6<String, String,Double,String,String,Double>> reduce = quarterData.groupBy(0).reduce(new ReduceFunction<Tuple6<String, String,Double,String,String,Double>>() {
            @Override
        ...
        String insertQuery = "INSERT INTO RE_LP_UE_COM_QUARTER(IEDNAME,ASSETYPE,LOCATION,PRODUCTMODEL,PRODUCTMODELB,PRODUCTMODELC,UTILIZATIONRATIO," +
