...
public class TotalLowPressureUseEfficiencyCompareQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String quarterQuery = "select ASSETYPE,LOCATION,PRODUCTMODELC,UTILIZATIONRATIO,RUNNINGTIME,CREATETIME" +
                " from RE_ALL_LP_UE_QUARTER where ASSETYPE like '低压开关设备%' and CREATETIME in "+RemindDateUtils.getLastTwoQuarterString();
        ...
        DataSet<Row> result = reduce.map(new MapFunction<Tuple6<String, Double,Double,String,String,Double>, Row>() {
            ...
            public Row map(Tuple6<String, Double,Double,String,String,Double> value) throws Exception {
                ...
                row.setField(7, value.f3);//时间-季度

                return row;
            }
        });

        String insertQuery = "INSERT INTO RE_ALL_LP_UE_COM_QUARTER(ASSETYPE,LOCATION,PRODUCTMODELC,UTILIZATIONRATIO," +
        ...
        env.execute("TotalLowPressureUseEfficiencyCompareQuarter");
    }
