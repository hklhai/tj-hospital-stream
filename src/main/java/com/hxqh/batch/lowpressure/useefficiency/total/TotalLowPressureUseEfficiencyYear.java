...
public class TotalLowPressureUseEfficiencyYear {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String quarterQuery = "select ASSETYPE,LOCATION,PRODUCTMODELC,sum(RUNNINGTIME),avg(UTILIZATIONRATIO)" +
                " from RE_LP_UE_YEAR where ASSETYPE like '低压开关设备%' and CREATETIME = '" + RemindDateUtils.getLastYear() + "' group by ASSETYPE,LOCATION,PRODUCTMODELC ";
        ...
        String insertQuery = "INSERT INTO RE_ALL_LP_UE_YEAR(ASSETYPE,LOCATION,PRODUCTMODELC,RUNNINGTIME,UTILIZATIONRATIO,CREATETIME) " +
                "VALUES(?,?,?,?,?,?)";
        ...
        env.execute("TotalLowPressureUseEfficiencyYear");
    }
