...
public class LowPressureAlarmQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sqlFirst = "select IEDName,alarmLevel,count(*) as levelCount from yx where Val='1' " +
                "and assetYpe like '低压开关设备%' and ColTime>='" + start + "' and ColTime<='" + end + "'  " +
                "group by IEDName,alarmLevel";
        ...
        String insertQuery = "INSERT INTO  RE_LP_ALARM_QUARTER(IEDNAME,ASSETYPE,LOCATION,PRODUCTMODELC," +
        ...
        env.execute("LowPressureAlarmQuarter");
    ...
    private static int[] getType() {
        return new int[]{Types.VARCHAR,Types.VARCHAR,Types.VARCHAR,Types.VARCHAR,
                Types.INTEGER, Types.DOUBLE,Types.INTEGER, Types.DOUBLE,Types.INTEGER, Types.DOUBLE,
