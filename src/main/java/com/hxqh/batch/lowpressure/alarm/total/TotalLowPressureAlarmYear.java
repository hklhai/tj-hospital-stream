...
public class TotalLowPressureAlarmYear {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Row> result = join.map(new MapFunction<Tuple6<String, String,Integer,Integer,Integer,String>, Row>() {
            ...
            public Row map(Tuple6<String, String,Integer,Integer,Integer,String> value) throws Exception {
                ...
                row.setField(11, RemindDateUtils.getLastYear());

                return row;
            }
        });

        String insertQuery = "INSERT INTO  RE_ALL_LP_ALARM_Y(ASSETYPE,LOCATION,PRODUCTMODELC," +
        ...
        env.execute("TotalLowPressureAlarmYear");
