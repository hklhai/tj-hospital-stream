...
public class LowPressureCurentCompareYear {
    public static void main(String[] args) throws Exception {
        ...
        //and CREATETIME in " + RemindDateUtils.getLastTwoYearString()
        String lowQuery = "select IEDNAME,ASSETYPE,LOCATION,PRODUCTMODELC,PRODUCTMODELB,PHASECURRENTAVG,CREATETIME from RE_LP_VA_Y where ASSETYPE like '低压开关设备%' and CREATETIME = '" + RemindDateUtils.getLastYear() +"' ";
        ...
        String insertQuery = "INSERT INTO RE_LP_CURRENT_COM_Y (IEDNAME,ASSETYPE,LOCATION,PRODUCTMODELC," +
        ...
        env.execute("LowPressureCurentCompareYear");
}
