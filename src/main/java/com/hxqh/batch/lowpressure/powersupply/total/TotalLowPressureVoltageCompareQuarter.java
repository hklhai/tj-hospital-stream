...
/**
 * 整体低压设备供应电最电压统计-季度比对，与额定电压400V比较
 * <p>
...
public class TotalLowPressureVoltageCompareQuarter {
    public static void main(String[] args) throws Exception {
        ...
        String voltageQuery = "select ASSETYPE,LOCATION,PRODUCTMODELC,PHASEVOLTAGEAVG " +
                "from RE_ALL_LP_VOLTAGE_Q where ASSETYPE like '低压开关设备%' and CREATETIME = '" + RemindDateUtils.getLastQuarter() + "' ";
        ...
        String insertQuery = "INSERT INTO RE_ALL_LP_VOLTAGE_COM_Q (ASSETYPE,LOCATION,PRODUCTMODELC,PHASEVOLTAGEAVG,COMPARISON,RATIO,CREATETIME) " +
                "VALUES(?,?,?,?,?,?,?)";
        ...
        env.execute("TotalLowPressureVoltageCompareQuarter");
}
