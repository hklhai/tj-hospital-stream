...
public class TotalLowPressureVoltageYear {
    public static void main(String[] args) throws Exception {
        ...
        String voltageQuery = "select ASSETYPE,LOCATION,PRODUCTMODELC,max(PHASEVOLTAGEMAX),min(PHASEVOLTAGEMIN),avg(PHASEVOLTAGEAVG) " +
                "from RE_LP_VA_Y where ASSETYPE like '低压开关设备%' and CREATETIME = '" + RemindDateUtils.getLastYear() + "' " +
        ...
        String insertQuery = "INSERT INTO RE_ALL_LP_VOLTAGE_Y (ASSETYPE,LOCATION,PRODUCTMODELC,PHASEVOLTAGEMAX,PHASEVOLTAGEMIN,PHASEVOLTAGEAVG,CREATETIME) " +
                "VALUES(?,?,?,?,?,?,?)";
        ...
        env.execute("TotalLowPressureVoltageYear");
}
