...
public class TransformerPowerSupplyQuarter {
...
//        String upperStart = "2020-03-01 00:00:00";
//        String upperEnd = "2020-04-30 23:59:59";

        //ColTime>='2020-03-01 00:00:00' and ColTime<='2020-03-31 23:59:59'
        ...
        DataSet<Row> result = join.map(new MapFunction<Tuple5<String, String, String,Double,Double>, Row>() {
            ...
            public Row map(Tuple5<String, String, String,Double,Double> value) throws Exception {
                ...
                row.setField(9, RemindDateUtils.getLastQuarter());//时间-季度
        ...
        String insertQuery = "INSERT INTO RE_TRANS_PS_QUARTER (IEDNAME,ASSETYPE,PRODUCTMODEL,LOCATION,PRODUCTMODELB,PRODUCTMODELC,PARENT,LOADVALUE,LOADRATIO,CREATETIME,LOSSVALUE,LOSSRATIO,LOSSDESC) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
