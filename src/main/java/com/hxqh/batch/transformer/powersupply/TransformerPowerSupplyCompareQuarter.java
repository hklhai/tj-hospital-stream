...
public class TransformerPowerSupplyCompareQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String selectQuery = "select IEDNAME,ASSETYPE,PRODUCTMODEL,LOCATION,PRODUCTMODELB,PRODUCTMODELC," +
                ...
                "RE_TRANS_PS_QUARTER where ASSETYPE='变压器' and CREATETIME in " + RemindDateUtils.getLastTwoQuarterString();
        ...
        String insertQuery = "INSERT INTO RE_TRANS_PS_COM_QUARTER (IEDNAME,ASSETYPE,PRODUCTMODEL," +
        ...
        env.execute("TransformerPowerSupplyCompareQuarter");
    }


    private static TypeInformation<?>[] getFieldTypes() {
        //不知道为啥非得是bigdecimal，不能是double，难道跟数据库存储的字段长度有关系？
