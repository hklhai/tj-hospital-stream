...
public class TotalTransformerUseEfficiencyStatisticsYear {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String transMonthQuery = "SELECT PRODUCTMODELC,LOADVALUE,CREATETIME FROM RE_TRANS_UE_MONTH where ASSETYPE='变压器' and CREATETIME  like '" + RemindDateUtils.getLastYear() + "%' ";
...
//reduce.print();
        ...
        String transQuery = "SELECT PRODUCTMODELC,ASSETYPE,max(PHASECURRENTMAX),min(PHASECURRENTMIN),avg(PHASECURRENTAVG) " +
                "FROM RE_TRANS_UE_INFO_YEAR where ASSETYPE='变压器' and CREATETIME = '" + RemindDateUtils.getLastYear() + "' " +
        ...
        String insertQuery = "INSERT INTO RE_ALL_TRANS_UE_INFO_YEAR(PRODUCTMODELC,ASSETYPE,MINMONTH,MAXMONTH," +
        ...
        env.execute("TotalTransformerUseEfficiencyStatisticsYear");
    }
