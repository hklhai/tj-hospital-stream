...
/**
 * 整体电压器设备总使用时长及停机时长--年度比对信息
 * <p>
 */
@SuppressWarnings("DuplicatedCode")
public class TotalTransformerUseEfficiencyCompareYear {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String transQuery = "select PRODUCTMODELC,ASSETYPE,UTILIZATIONRATIO,DOWNTIME,RUNNINGTIME,CREATETIME " +
                "from RE_ALL_TRANS_UE_YEAR where ASSETYPE='变压器' " +
        ...
        String insertQuery = "INSERT INTO RE_ALL_TRANS_UE_COM_YEAR(PRODUCTMODELC,ASSETYPE,UTILIZATIONRATIO,DOWNTIME," +
