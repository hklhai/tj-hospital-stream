...
public class TransformerUseEfficiencyStatisticsQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String transMaximumQuery = "select u.* from (SELECT IEDNAME,ASSETYPE,PRODUCTMODEL,LOCATION,PRODUCTMODELB,PRODUCTMODELC,PARENT,LOADVALUE,CREATETIME,row_number() over(PARTITION BY IEDNAME ORDER BY LOADVALUE desc) AS rn FROM RE_TRANS_UE_MONTH where ASSETYPE='变压器' and CREATETIME in " + RemindDateUtils.getLastQuarterString() + " ) u where u.rn = 1";
        ...
        String transMinimumQuery = "select u.* from (SELECT IEDNAME,ASSETYPE,PRODUCTMODEL,LOCATION,PRODUCTMODELB,PRODUCTMODELC,PARENT,LOADVALUE,CREATETIME,row_number() over(PARTITION BY IEDNAME ORDER BY LOADVALUE asc) AS rn FROM RE_TRANS_UE_MONTH where ASSETYPE='变压器' and CREATETIME in " + RemindDateUtils.getLastQuarterString() + " ) u where u.rn = 1";
...
//        String start = ""
//                ColTime>=%272020-03-01%2000:00:00%27%20and%20ColTime<=%272020-03-31%2023:59:59
        ...
        DataSet<Row> result = transjoin.join(dataSet).where(2).equalTo(0).with(new JoinFunction<Tuple5<String, String,String,String,String>, Tuple4<String, Double, Double, Double>, Row>() {
            ...
            public Row join(Tuple5<String, String,String,String,String> first, Tuple4<String, Double, Double, Double> second) throws Exception {
                ...
                row.setField(12, RemindDateUtils.getLastQuarter());
                return row;
            }
        });
        ...
        String insertQuery = "INSERT INTO RE_TRANS_UE_INFO_QUARTER(IEDNAME,ASSETYPE,PRODUCTMODEL,LOCATION,PRODUCTMODELB,PRODUCTMODELC,PARENT," +
        ...
        env.execute("TransformerUseEfficiencyStatisticsQuarter");
    }
