...
public class TotalTransFormerHealthCompareQuarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String quarterQuery = "select ASSETYPE,LOCATION,PRODUCTMODEL,PRODUCTMODELC,SCORE,CREATETIME from RE_ALL_TRANS_HEA_Q where ASSETYPE='变压器' and CREATETIME in " + RemindDateUtils.getLastTwoQuarterString();
        ...
        String insertQuery = "INSERT INTO RE_ALL_TRANS_HEA_COM_Q (ASSETYPE,LOCATION,PRODUCTMODEL,PRODUCTMODELC,SCORE,CREATETIME,COMPARISON,RATIO) VALUES(?,?,?,?,?,?,?,?)";
