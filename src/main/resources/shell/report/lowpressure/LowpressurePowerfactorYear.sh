...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powerfactor.LowpressurePowerfactorYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowpressurePowerfactorYear.log 2>&1 &
