...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powerfactor.total.TotalLowpressurePowerfactorYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowpressurePowerfactorYear.log 2>&1 &
