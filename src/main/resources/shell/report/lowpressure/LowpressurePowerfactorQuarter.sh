...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powerfactor.LowpressurePowerfactorQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowpressurePowerfactorQuarter.log 2>&1 &
