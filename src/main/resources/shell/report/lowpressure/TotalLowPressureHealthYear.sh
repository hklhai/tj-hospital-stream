...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.health.total.TotalLowPressureHealthYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureHealthYear.log 2>&1 &
