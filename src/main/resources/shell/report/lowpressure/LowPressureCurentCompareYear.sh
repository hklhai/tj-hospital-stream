...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powersupply.LowPressureCurentCompareYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureCurentCompareYear.log 2>&1 &
