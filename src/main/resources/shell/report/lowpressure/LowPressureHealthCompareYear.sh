...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.health.LowPressureHealthCompareYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureHealthCompareYear.log 2>&1 &
