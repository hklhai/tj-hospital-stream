...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.useefficiency.total.TotalLowPressureUseEfficiencyCompareQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureUseEfficiencyCompareQuarter.log 2>&1 &
