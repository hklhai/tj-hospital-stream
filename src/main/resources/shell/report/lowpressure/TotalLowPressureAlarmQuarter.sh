...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.alarm.total.TotalLowPressureAlarmQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureAlarmQuarter.log 2>&1 &
