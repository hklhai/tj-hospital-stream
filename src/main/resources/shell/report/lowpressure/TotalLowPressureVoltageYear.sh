...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powersupply.total.TotalLowPressureVoltageYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureVoltageYear.log 2>&1 &
