...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.electricalmeasurement.total.TotalLowPressureElectricalMeasurementYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureElectricalMeasurementYear.log 2>&1 &
