...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.health.LowPressureHealthCompareQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureHealthCompareQuarter.log 2>&1 &
