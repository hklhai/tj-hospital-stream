...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.health.total.TotalLowPressureHealthQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureHealthQuarter.log 2>&1 &
