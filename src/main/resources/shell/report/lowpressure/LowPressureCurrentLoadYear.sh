...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powersupply.LowPressureCurrentLoadYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureCurrentLoadYear.log 2>&1 &
