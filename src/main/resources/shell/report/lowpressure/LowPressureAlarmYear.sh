...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.alarm.LowPressureAlarmYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureAlarmYear.log 2>&1 &
