...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.electricalmeasurement.total.TotalLowPressureElectricalMeasurementCompYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureElectricalMeasurementCompYear.log 2>&1 &
