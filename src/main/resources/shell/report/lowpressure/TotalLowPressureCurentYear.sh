...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powersupply.total.TotalLowPressureCurentYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureCurentYear.log 2>&1 &
