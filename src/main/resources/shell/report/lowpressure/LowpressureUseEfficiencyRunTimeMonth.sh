...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.useefficiency.LowpressureUseEfficiencyRunTimeMonth /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowpressureUseEfficiencyRunTimeMonth.log 2>&1 &
