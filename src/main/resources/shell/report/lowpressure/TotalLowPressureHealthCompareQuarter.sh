...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.health.total.TotalLowPressureHealthCompareQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureHealthCompareQuarter.log 2>&1 &
