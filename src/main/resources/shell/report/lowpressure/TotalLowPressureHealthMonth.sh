...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.health.total.TotalLowPressureHealthMonth /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureHealthMonth.log 2>&1 &
