...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.health.LowPressureHealthYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureHealthYear.log 2>&1 &
