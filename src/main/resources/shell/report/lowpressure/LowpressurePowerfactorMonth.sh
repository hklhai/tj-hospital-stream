...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powerfactor.LowpressurePowerfactorMonth /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowpressurePowerfactorMonth.log 2>&1 &
