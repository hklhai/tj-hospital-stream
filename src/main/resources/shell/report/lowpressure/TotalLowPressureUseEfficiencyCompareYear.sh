...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.useefficiency.total.TotalLowPressureUseEfficiencyCompareYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureUseEfficiencyCompareYear.log 2>&1 &
