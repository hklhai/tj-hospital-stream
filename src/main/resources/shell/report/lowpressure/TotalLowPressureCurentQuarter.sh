...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powersupply.total.TotalLowPressureCurentQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureCurentQuarter.log 2>&1 &
