...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powerfactor.total.TotalLowpressurePowerfactorQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowpressurePowerfactorQuarter.log 2>&1 &
