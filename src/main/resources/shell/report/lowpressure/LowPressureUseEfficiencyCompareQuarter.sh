...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.useefficiency.LowPressureUseEfficiencyCompareQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureUseEfficiencyCompareQuarter.log 2>&1 &
