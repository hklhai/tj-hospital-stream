...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powersupply.total.TotalLowPressureCurrentLoadQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureCurrentLoadQuarter.log 2>&1 &
