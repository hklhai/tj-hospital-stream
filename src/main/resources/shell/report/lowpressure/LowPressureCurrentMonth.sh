...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powersupply.LowPressureCurrentMonth /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureCurrentMonth.log 2>&1 &
