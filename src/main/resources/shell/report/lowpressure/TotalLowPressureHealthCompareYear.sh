...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.health.total.TotalLowPressureHealthCompareYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureHealthCompareYear.log 2>&1 &
