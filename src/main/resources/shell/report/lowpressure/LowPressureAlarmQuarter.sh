...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.alarm.LowPressureAlarmQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureAlarmQuarter.log 2>&1 &
