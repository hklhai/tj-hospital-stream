...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.useefficiency.LowPressureUseEfficiencyCompareYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/LowPressureUseEfficiencyCompareYear.log 2>&1 &
