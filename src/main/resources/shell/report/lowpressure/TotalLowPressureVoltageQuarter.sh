...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.lowpressure.powersupply.total.TotalLowPressureVoltageQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalLowPressureVoltageQuarter.log 2>&1 &
