...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.powersupply.total.TotalTransformerPowerSupplyTop3Year /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalTransformerPowerSupplyTop3Year.log 2>&1 &
