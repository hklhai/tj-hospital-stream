...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.powersupply.TransformerPowerSupplyQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransformerPowerSupplyQuarter.log 2>&1 &
