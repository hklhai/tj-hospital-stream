...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.powersupply.TransformerPowerSupplyYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransformerPowerSupplyYear.log 2>&1 &
