...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.total.TotalTransFormerUseEfficiencyFengYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalTransFormerUseEfficiencyFengYear.log 2>&1 &
