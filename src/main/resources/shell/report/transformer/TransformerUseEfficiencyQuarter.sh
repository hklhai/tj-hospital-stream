...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.TransformerUseEfficiencyQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransformerUseEfficiencyQuarter.log 2>&1 &
