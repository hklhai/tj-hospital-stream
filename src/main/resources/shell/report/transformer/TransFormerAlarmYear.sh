...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.alarm.TransFormerAlarmYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransFormerAlarmYear.log 2>&1 &
