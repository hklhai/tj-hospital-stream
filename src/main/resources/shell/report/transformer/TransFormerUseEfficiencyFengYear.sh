...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.TransFormerUseEfficiencyFengYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransFormerUseEfficiencyFengYear.log 2>&1 &
