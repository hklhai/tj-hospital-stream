...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.TransformerUseEfficiencyStatisticsQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransformerUseEfficiencyStatisticsQuarter.log 2>&1 &
