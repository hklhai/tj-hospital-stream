...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.alarm.TransFormerAlarmQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransFormerAlarmQuarter.log 2>&1 &
