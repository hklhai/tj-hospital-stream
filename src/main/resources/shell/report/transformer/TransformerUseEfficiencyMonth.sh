...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.TransformerUseEfficiencyMonth /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransformerUseEfficiencyMonth.log 2>&1 &
