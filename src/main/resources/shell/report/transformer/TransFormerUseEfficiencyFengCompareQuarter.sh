...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.TransFormerUseEfficiencyFengCompareQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransFormerUseEfficiencyFengCompareQuarter.log 2>&1 &
