...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.alarm.total.TotalTransFormerAlarmQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalTransFormerAlarmQuarter.log 2>&1 &
