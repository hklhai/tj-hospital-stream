...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.health.TransFormerHealthYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransFormerHealthYear.log 2>&1 &
