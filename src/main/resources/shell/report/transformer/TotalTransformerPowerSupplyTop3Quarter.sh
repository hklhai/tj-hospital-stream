...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.powersupply.total.TotalTransformerPowerSupplyTop3Quarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalTransformerPowerSupplyTop3Quarter.log 2>&1 &
