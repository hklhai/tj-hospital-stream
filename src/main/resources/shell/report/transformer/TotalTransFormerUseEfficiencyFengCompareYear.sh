...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.total.TotalTransFormerUseEfficiencyFengCompareYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalTransFormerUseEfficiencyFengCompareYear.log 2>&1 &
