...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.alarm.total.TotalTransFormerAlarmYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalTransFormerAlarmYear.log 2>&1 &
