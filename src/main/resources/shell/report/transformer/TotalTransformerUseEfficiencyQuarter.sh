...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.total.TotalTransformerUseEfficiencyQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TotalTransformerUseEfficiencyQuarter.log 2>&1 &
