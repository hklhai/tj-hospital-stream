...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.TransFormerUseEfficiencyFengCompareYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransFormerUseEfficiencyFengCompareYear.log 2>&1 &
