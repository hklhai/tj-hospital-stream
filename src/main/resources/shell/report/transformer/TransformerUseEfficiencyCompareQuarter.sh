...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.TransformerUseEfficiencyCompareQuarter /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransformerUseEfficiencyCompareQuarter.log 2>&1 &
