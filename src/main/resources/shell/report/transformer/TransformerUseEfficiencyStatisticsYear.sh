...
nohup /root/app/flink-1.8.0/bin/flink run -c com.hxqh.batch.transformer.useefficiency.TransformerUseEfficiencyStatisticsYear /root/TJJar/batch/tj-hospital.jar > /root/TJJar/TransformerUseEfficiencyStatisticsYear.log 2>&1 &
